...
class suboptions_widget extends WP_Widget {
	...
	function suboptions_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'suboptions-widget', __('Icons Rss. Titter. Facebook', 'suboptions'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $rss_url )
			echo '<a target="_blank" title="Subscribe via RSS" href="'.$rss_url.'"><img class="suboptions-icon rounded-corners rss-icon" alt="Subscribe via RSS" style="background: '.$rss_col.'; width: '.$size.'px; height: '.$size.'px; " src="'.get_bloginfo('wpurl').'/'.PLUGINDIR.'/subscription-options/images/icon3_rss.png"/></a>';	
		...
		if ( $twitter_url )
			echo '<a target="_blank" title="Subscribe via Twitter" href="'.$twitter_url.'"><img class="suboptions-icon rounded-corners twitter-icon" alt="Subscribe via Twitter" style="background: '.$twitter_col.'; width: '.$size.'px; height: '.$size.'px; " src="'.get_bloginfo('wpurl').'/'.PLUGINDIR.'/subscription-options/images/icon3_tw.png"/></a>';
		
		/* If a Facebook Page URL was entered, display the Facebook icon. */			
		if ( $facebook_url )
			echo '<a target="_blank" title="Subscribe via Facebook" href="'.$facebook_url.'"><img class="suboptions-icon rounded-corners facebook-icon" alt="Subscribe via Facebook" style="background: '.$facebook_col.'; width: '.$size.'px; height: '.$size.'px; " src="'.get_bloginfo('wpurl').'/'.PLUGINDIR.'/subscription-options/images/icon3_fb.png"/></a>';
	 ...
	 * when creating your form elements. This handles the confusing stuff.http://localhost/bram/?feed=rss2
	 */
	function form( $instance ) {
		$defaults = array(
			
			/* Set up some default standard widget settings. */
			'title' => 'Icons Titter. Facebook:',
			'size' => '28',
			'rss_url' => '',
			'rss_col' => '#FF9831',
			'email_url' => '',
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'rss_url' ); ?>"><?php _e('RSS Feed URL :', 'suboptions'); ?></label>
			<input class="suboptions-url" id="<?php echo $this->get_field_id( 'rss_url' ); ?>" name="<?php echo $this->get_field_name( 'rss_url' ); ?>" value="<?php echo $instance['rss_url']; ?>" />
		</p>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'twitter_url' ); ?>"><?php _e('Twitter Stream URL :', 'suboptions'); ?></label>
			<input class="suboptions-url" id="<?php echo $this->get_field_id( 'twitter_url' ); ?>" name="<?php echo $this->get_field_name( 'twitter_url' ); ?>" value="<?php echo $instance['twitter_url']; ?>" />
         
		</p>
		
		<!-- Facebook Page URL & Colour: Text Input -->
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'facebook_url' ); ?>"><?php _e('Facebook Page URL :', 'suboptions'); ?></label>
			<input class="suboptions-url" id="<?php echo $this->get_field_id( 'facebook_url' ); ?>" name="<?php echo $this->get_field_name( 'facebook_url' ); ?>" value="<?php echo $instance['facebook_url']; ?>" />
		</p>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'linkedin_url' ); ?>"><?php _e('LinkedIn Profile URL :', 'suboptions'); ?></label>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'flickr_url' ); ?>"><?php _e('Flickr Page URL :', 'suboptions'); ?></label>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'google_url' ); ?>"><?php _e('Google Plus URL :', 'suboptions'); ?></label>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'podcast_url' ); ?>"><?php _e('Podcasting Service URL & ', 'suboptions'); ?></label>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php _e('YouTube Channel URL & ', 'suboptions'); ?></label>
		...
		<p class="suboptions-item">
			<label class="suboptions-label" for="<?php echo $this->get_field_id( 'pinterest_url' ); ?>"><?php _e('Pinterest Page URL & ', 'suboptions'); ?></label>
