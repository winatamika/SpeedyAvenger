...
define("OT_URL", SITE_URL . "/belajar/"); //define("OT_URL", SITE_URL . "/category/belajar/");
...
function my_show_extra_profile_fields($user) {
    ...
    <table class="form-table">
        <tr>
            <th><label for="tipe_user">Nama Lengkap</label></th>
            <td>
                <?php echo isset($biodata['nama_lengkap'])? $biodata['nama_lengkap']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Tempat/Tanggal Lahir</label></th>
            <td>
                <?php echo isset($biodata['tempat_lahir'])? $biodata['tempat_lahir']:'';?>/
                <?php echo isset($biodata['tgl_lahir'])? $biodata['tgl_lahir']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="no_ktp">No KTP</label></th>
            <td>
                <?php echo isset($biodata['no_ktp'])? $biodata['no_ktp']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Jenis Kelamin</label></th>
            <td>
                <?php echo isset($biodata['jenis_kelamin'])? $biodata['jenis_kelamin']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Agama</label></th>
            <td>
                <?php echo isset($biodata['agama'])? $biodata['agama']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Alamat Rumah</label></th>
            <td>
                <?php echo isset($biodata['alamat_rumah'])? $biodata['alamat_rumah']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Nomor Telepon / HP</label></th>
            <td>
                <?php echo isset($biodata['nomor_telepon_hp'])? $biodata['nomor_telepon_hp']:'';?>
            </td>
        </tr>
        <tr>
            <th><label for="tipe_user">Email</label></th>
            <td>
                <?php echo isset($biodata['email'])? $biodata['email']:'';?>
            </td>
        </tr>
    </table>
...
function sa_redirect_page() {
    ...
    $pra_avengers_pages = array(10, 12, 18, 20, 21, 110, 158, 160, 177, 253, 274, 288, 285, 303, 329, 337, 348, 350);
    ...
    if ( is_page_template("page-register.php") AND !is_user_logged_in() ) {
            ...
            if (!is_page($pra_avengers_pages)) {
                if (!in_category($pra_avengers_categories)) {
                    if (!is_category($pra_avengers_categories)) {
                        ...
                        if(isset($biodata_user) OR $biodata_user==""){
