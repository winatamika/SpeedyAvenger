			...
			<?php
				...
				<?php if ( ucfirst($questionArray['type']) == 'Multiple'
						...
						if ( isset($section['answers'][$questionId]['mark']) 
						  && ($section['answers'][$questionId]['mark'] == 'correct' || $section['answers'][$questionId]['mark'] == 'benar') ){
					...
					<b>Result :</b><?php echo $section['answers'][$questionId]['mark']; ?> <!--<b>Correct/Incorrect</b> - <?php if (isset($section['answers'][$questionId]['mark'])) { if ($section['answers'][$questionId]['mark'] == "incorrect") { echo '<font style="color: red">Incorrect</font>'; } elseif ($section['answers'][$questionId]['mark'] == "correct") { echo '<font style="color: green">Correct</font>';} } else { echo '<font style="color: red">Incorrect</font>'; } ?>--><br /></div>
				<?php } else { 
					?>		
					<div style="margin-left: 35px; margin-bottom: 40px;">		
					<b>Answer Given</b>
