        ...
        <tr>
            ...
            <td>
                ...
                <select name="tipe_user" id="tipe_user">
					...
					<option value="admin-witel-barat" <?php echo ($tipe_user == "admin-witel-barat") ? "selected" : ""; ?> >Admin Witel Barat</option>
					<option value="admin-witel-timur" <?php echo ($tipe_user == "admin-witel-timur") ? "selected" : ""; ?> >Admin Witel Timur</option>
...
register_nav_menus(array(
	...
	'header_admin_witel' => __('Header Admin Witel', 'promotion'),
    ));
